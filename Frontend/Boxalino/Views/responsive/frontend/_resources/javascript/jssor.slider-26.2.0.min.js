(function (j, h, c, g, d, k, f) {/*! Jssor */
    ...
    var b = j.$Jssor$ = new function () {
        ...
        function Ib() {
            if (!O) {
                O = {Ze: "ontouchstart" in j || "createTouch" in h};
                var a;
                if (E.pointerEnabled || (a = E.msPointerEnabled)) O.Ed = a ? "msTouchAction" : "touchAction"
            }
            return O
        }
        ...
        function Z(a) {
            a.constructor === Z.caller && a.Wb && a.Wb.apply(a, Z.caller.arguments)
        }

        i.Wb = Z;
        i.$GetElement = function (a) {
            if (i.gg(a)) a = h.getElementById(a);
            return a
        };
            ...
            if (c != undefined){
                if (a !== f) c.style[d] = a == f ? "" : a; else {
                    ...
                    if (a == "" && j.getComputedStyle) {
                        if(c[1] != undefined){
                            b = c[1].ownerDocument.defaultView.getComputedStyle(c[1], g);
                        } else {
        ...
        i.Ag = m("transformOrigin", 4);
        i.tg = m("backfaceVisibility", 4);
        i.sg = m("transformStyle", 4);
        i.rg = m("perspective", 6);
        i.wg = m("perspectiveOrigin", 4);
        i.vg = function (b, a) {
        ...
        i.Ac = function (a, b) {
            var c = i.rc(a);
            b & 1 && i.M(a, (i.$CssWidth(c) - i.$CssWidth(a)) / 2);
            b & 2 && i.L(a, (i.$CssHeight(c) - i.$CssHeight(a)) / 2)
        };
        var W = {$Top: g, $Right: g, $Bottom: g, $Left: g, v: g, u: g};
        i.Zf = function (a) {
            var b = i.$CreateDiv();
            s(b, {pc: "block", qb: i.F(a), $Top: 0, $Left: 0, v: 0, u: 0});
            var d = i.bd(a, W);
            i.Jb(b, a);
            i.$AppendChild(b, a);
            var e = i.bd(a, W), c = {};
        ...
        i.C = m("zIndex", 1);
        i.sc = function (b, a, c) {
            if (a != f) Fb(b, a, c); else return Db(b)
        };
        ...
        function s(h, l) {
            var e = gb(), b = I(), d = eb(), j = P(h);

            function k(b, d, a) {
                var e = b.yb(p(-d / 2, -a / 2)), f = b.yb(p(d / 2, -a / 2)), g = b.yb(p(d / 2, a / 2)),
                    h = b.yb(p(-d / 2, a / 2));
                b.yb(p(300, 300));
            ...
            function a(d, a) {
                ...
                var n = a.$TranslateZ || 0, p = (a.$RotateX || 0) % 360, q = (a.$RotateY || 0) % 360,
                    u = (a.$Rotate || 0) % 360, l = a.$ScaleX, m = a.$ScaleY, g = a.yh;
                if (l == f) l = 1;
                if (m == f) m = 1;
                if (g == f) g = 1;
                if (e) {
            ...
            s = function (e, c) {
                ...
                if (c.Ce) if (d) yb(i.$CreateCallback(g, R, e, c)); else a(e, c)
            };
            i.nc = R;
            if (d) i.nc = s;
            if (e) i.nc = a; else if (!b) a = R;
            i.I = s;
            s(h, l)
        }
        ...
        i.yc = function (c, d) {
            var a = c || {};
            if (c) if (b.dd(c)) a = {V: a}; else if (b.dd(c.$Clip)) a.$Clip = {V: c.$Clip};
            a.V = a.V || d;
            if (a.$Clip) a.$Clip.V = a.$Clip.V || d;
            return a
        };
        ...
        function wb(c, a) {
            ...
            n(c, function (c, d) {
                var e = c;
                if (a[d] != f) if (i.ic(c)) e = c + a[d]; else e = wb(c, a[d]);
                b[d] = e
            });
            return b
        }
        ...
        i.Md = function (n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                for (var i in j) {
                    ...
                    var x = c.floor(h);
                    if (h != x) h -= x;
                    var k = t.V || e.$Linear, m, E = n[i], q = j[i];
                    if (b.ic(q)) {
                        k = t[i] || k;
                        var A = k(h);
                        m = E + q * A
            ...
            if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.B && !a.$Clip.z && a.$Clip.$Right == o.$OriginalWidth && a.$Clip.$Bottom == o.$OriginalHeight) a.$Clip = g;
            return a
        }
    };
    ...
    var l = function (A, D, g, L, O, J) {
        ...
        function K() {
            if (p) {
                var d = b.W(), e = c.min(d - B, g.Fd), a = h + e * n;
                B = d;
                if (a * n >= m * n) a = m;
                s(a);
        ...
        a.Qb = a.Jd = a.Kd = a.Pc = b.fd;
        a.Oc = b.W();
        g = b.s({$Interval: 16, Fd: 50}, g);
        o = g.Uc;
        x = g.ve;
        w = g.re;
        e = i = A;
    ...
    var m = {Eb: "data-scale", Ec: "data-scale-ratio", wb: "data-autocenter"}, n = new function () {
        var a = this;
        ...
        h.$FormationStraight = function (f) {
            for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.ac, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++) for (a = 0; a < d; a++) {
                switch (s) {
                    case j:
                        c = h - (a * e + (q - b));
                        break;
        ...
        h.$FormationSwirl = function (q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.ac, A = [], z = [], u = 0, c = 0, h = 0, r = x - 1,
                s = y - 1, t, p, v = 0;
            switch (B) {
                case j:
                    c = r;
        ...
        h.$FormationZigZag = function (p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.ac, t = [], u = 0, c = 0, d = 0, q = w - 1, r = x - 1,
                y, h, s = 0;
            switch (z) {
                case j:
                    c = q;
        ...
        h.$FormationStraightStairs = function (q) {
            var u = q.$Cols, v = q.$Rows, e = q.$Assembly, t = q.ac, r = [], s = 0, c = 0, d = 0, f = u - 1, h = v - 1,
                x = t - 1;
            switch (e) {
                case j:
                case m:
    ...
    j.$JssorSlideshowRunner$ = function (m, s, p, u, z, A) {
        ...
        function j(h, f, g) {
            ...
            t(a);
            a.ac = a.$Cols * a.$Rows;
            a.$Easing = b.yc(a.$Easing, e.$Linear);
            ...
            a.fe = function (c, b) {
                ...
                if (!a.fc[f]) {
                    a.fc[f] = {v: c, u: b};
                    for (var d = 0; d < a.$Cols; d++) for (var e = 0; e < a.$Rows; e++) a.fc[f][e + "," + d] = {
                        $Top: e * b,
                        $Right: d * c + c,
                        $Bottom: e * b + b,
                        $Left: d * c
        ...
        function n(z, i, a, v, n, l) {
            var y = this, t, u = {}, h = {}, m = [], f, e, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0,
                g = a.fe(n, l), o = B(a), C = o.length - 1, s = a.$Duration + a.$Delay * C, w = v + s, j = a.$SlideOut,
                x;
            w += 50;
            ...
            y.dc = function (d) {
                ...
                if (e || x) {
                    ...
                    b.$Each(h, function (a, e) {
                        ...
                        if (a.Zc != d) {
                            if (!a.Zc && !j) b.A(m[e]); else d == a.ke && j && b.X(m[e]);
                            a.Zc = d;
                            b.I(m[e], a[d])
                        }
                    })
            ...
            b.$Each(o, function (i, m) {
                b.$Each(i, function (G) {
                    ...
                    b.$Each(e, function (a, c) {
                        if (b.ic(a)) if (a != f[c]) r[c] = a - f[c]
                    });
                    u[v] = j ? f : e;
                    var D = a.le, y = c.round(m * a.$Delay / a.$Interval);
                    h[v] = new Array(y);
                    h[v].ee = y;
                    h[v].ke = y + D - 1;
                    for (var F = 0; F <= D; F++) {
                        var E = b.Md(f, r, F / D, a.$Easing, a.$During, a.$Round, {
                            $Move: a.$Move,
                            $OriginalWidth: n,
                            $OriginalHeight: l
                        });
        ...
        a.ze = function (x, y, k, l, b, t) {
            ...
            g["no-image"] = !l.Zb;
            e["no-image"] = !k.Zb;
            var o = g, q = e, w = b, d = b.$Brother || j({}, i, t);
            if (!b.$SlideOut) {
                o = e;
                q = g
            }
    ...
    j.$JssorBulletNavigator$ = function (a, E) {
        ...
        f.Nc = function (x) {
            if (!w) {
                ...
                for (var f = 0; f < u; f++) {
                    var t = b.Mf();
                    b.$InnerText(t, f + 1);
                    var k = b.hd(h, "numbertemplate", t, d);
                    b.F(k, "absolute");
                    var p = f % (m + 1);
                    b.M(k, !i ? n * p : f % j * n);
        ...
        f.oc = e = b.s({$SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1}, E);
        ...
        z = e.$SpacingY;
        i = e.$Orientation - 1;
        e.$Scale == k && n.R(a, m.Eb, 1);
        e.$AutoCenter && n.R(a, m.wb, e.$AutoCenter);
        n.bc(a)
    };
    j.$JssorArrowNavigator$ = function (a, e, i, A, z, x) {
        ...
        function u() {
            s.$Enable(i.$Loop || !j.he(h));
            r.$Enable(i.$Loop || !j.ge(h))
        }
        ...
        if (f.$AutoCenter) {
            n.R(a, m.wb, f.$AutoCenter);
            n.R(e, m.wb, f.$AutoCenter)
        }
        n.bc(a);
        n.bc(e)
    };
    j.$JssorThumbnailNavigator$ = function (f, E) {
        var r = this, x, A, u, a, y = [], B, z, e, l, q, t, s, j, v, h, w;
        o.call(r);
        f = b.$GetElement(f);
        ...
        function D(m, f) {
            ...
            function i(g) {
                if (g || !v.ie()) {
                    var c = e - f % e, a = v.Sd((f + c) / e - 1), b = a * e + e - c;
                    if (a < 0) b += x % e;
                    if (a >= A) b -= x % e;
                    r.j(p.Yb, b, k, d)
                }
            ...
            h.mb = f;
            h.Rd = n;
            j = m.be || m.Zb || b.$CreateDiv();
            h.Rb = c = b.hd(w, "thumbnailtemplate", j, d);
            l = b.hc(c);
        ...
        r.Nc = function (G, H) {
            if (!C) {
                ...
                j = c.min(j, A);
                var w = t + (t + l) * (e - 1) * (1 - g), p = s + (s + q) * (e - 1) * g, n = w + (w + l) * (j - 1) * g,
                    m = p + (p + q) * (j - 1) * (1 - g);
                n = c.min(B, n);
                m = c.min(z, m);
                ...
                b.$Each(H, function (k, f) {
                    var i = new D(k, f), d = i.Rb, a = c.floor(f / e), j = f % e;
                    b.M(d, (t + l) * j * (1 - g));
                    b.L(d, (s + q) * j * g);
                    if (!o[a]) {
                        o[a] = b.$CreateDiv();
        ...
        r.oc = a = b.s({$SpacingX: 0, $SpacingY: 0, $Orientation: 1, $ActionMode: 1}, E);
        B = b.$CssWidth(f);
        z = b.$CssHeight(f);
        ...
        q = a.$SpacingY;
        j = a.$Cols;
        a.$Scale == k && n.R(f, m.Eb, 1);
        a.$AutoCenter &= a.$Orientation;
        a.$AutoCenter && n.R(f, m.wb, a.$AutoCenter);
        n.bc(f)
    };
    ...
    j.$JssorCaptionSlideo$ = function (v, k, u, E) {
        var a = this, w, n = {}, o = k.$Transitions, r = k.$Controls, h = new l(0, 0), p = [], i = [], D = E,
            f = D ? 1e8 : 0;
        l.call(a, 0, 0);
        ...
        function q(d, c) {
            ...
            b.$Each(d, function (d, f) {
                var e = n[f];
                if (e) {
                    if (b.vd(d)) d = q(d, c || f == "e"); else if (c) if (b.ic(d)) d = w[d];
                    a[e] = d
                }
            });
            return a
        ...
        function t(d, e) {
            ...
            b.$Each(c, function (c) {
                ...
                if (h) {
                    var d = b.$AttributeEx(c, "t"), g = o[b.uc(d)] || o[d], f = {$Elmt: c, Vc: g};
                    a.push(f)
                }
                a = a.concat(t(c, e + 1))
            });
        ...
        function z(t, u, h) {
            ...
            b.$Each(u, function (i) {
                var g = b.s(d, {}, q(i)), j = b.yc(g.$Easing);
                delete g.$Easing;
                if (g.$Left) {
                    g.z = g.$Left;
                    j.z = j.$Left;
            ...
            if (a && e) {
                e.we();
                var i = e, k, j = e.mc(), p = e.Y(), s = c.max(p, a.Jf);
                if (a.fb < p) {
                    if (a.fb > j) {
                        i = new l(j, a.fb - j);
                        i.J(e, d)
                    } else i = g;
                    k = new l(a.fb, s - j, {Uc: s - a.fb, ve: d});
                    k.J(e, d)
                }
                i && a.vc.push(i);
                k && a.Ud.push(k)
        ...
        function j(k, d, e) {
            ...
            if (g > 4) for (var m = c.ceil(g / 4), a = 0; a < m; a++) {
                var h = d.slice(a * 4, c.min(a * 4 + 4, g)), i = new l(h[0].fb, 0);
                j(i, h, e);
                k.J(i)
            } else b.$Each(d, function (a) {
                b.$Each(e ? a.Ud : a.vc, function (a) {
                    e && a.Kc(f - a.Y());
                    k.J(a)
                })
            })
        ...
        y(t(v, 1));
        j(h, i);
        var x = k.$Breaks || [], s = x[b.uc(b.$AttributeEx(v, "b"))];
        if (s) A(s); else {
            a.J(h);
            f = h.Y();
            a.Kc(u);
    ...
    var i = j.$JssorSlider$ = function () {
        var a = this;
        b.hg(a, o);
        var Fb = "data-jssor-slider", Vb = "data-jssor-thumb", v, n, S, kb, bb, pb, ab, Q, K, J, Pb, kc, oc = 1, jc = 1,
            Xb = 1, ac = {}, y, X, Db, Rb, Ob, ob, rb, qb, jb, s = -1, Ib, q, N, L, wb, yb, zb, gb, G, U, Y, x, V, xb,
            eb = [], fc, hc, bc, pc, Kc, u, lb, H, dc, vb, Gb, ec, cb, O = 0, I = Number.MAX_VALUE,
            E = Number.MIN_VALUE, gc, C, mb, R, M = 1, Z, A, db, Jb = 0, Kb = 0, P, sb, tb, nb, w, hb, z, Lb, fb = [],
            Sb = b.$Device(), ub = Sb.Ze, B = [], D, T, F, Eb, Ub, W;

        function wc(e, k, o) {
            var l = this, h = {$Top: 2, $Right: 1, $Bottom: 2, $Left: 1},
                n = {$Top: "top", $Right: "right", $Bottom: "bottom", $Left: "left"}, g, a, f, i, j = {};
            l.$Elmt = e;
            l.$ScaleSize = function (q, p, t) {
                ...
                if (!f) {
                    f = b.Zf(e);
                    g = e.parentNode;
                    i = {$Scale: b.Bb(e, m.Eb, 1), $AutoCenter: b.Bb(e, m.wb)};
                    b.$Each(n, function (c, a) {
                        j[a] = b.Bb(e, "data-scale-" + c, 1)
                    });
                    a = e;
                    if (k) {
                        a = b.$CloneNode(g, d);
        ...
        function Jc() {
            ...
            b.Kf = function () {
                var a = b.Z();
                a = t(a);
                var d = c.round(a), g = d, f = a - c.floor(a), e = Wb(a);
                return {mb: g, Of: d, qb: f, pc: a, Sf: e}
            };
            b.Qb = function (e, b) {
                var g = t(b);
                if (c.abs(b - e) > 1e-5) {
        ...
        function Hc() {
            var a = this, b = Lb.$Elmt;
            l.call(a, -1, 2, {$Easing: e.$Linear, re: {qb: nc}, Uc: q}, b, {qb: 1}, {qb: -2});
            a.Rb = b
        }
        ...
        function zc(o, m) {
            ...
            b.Jd = function () {
                Z = d;
                db = g;
                a.j(i.$EVT_SWIPE_START, t(w.cb()), w.cb())
            };
            b.Kd = function () {
                Z = k;
                j = k;
                var b = w.Kf();
                a.j(i.$EVT_SWIPE_END, t(w.cb()), w.cb());
                if (!A) {
                    Lc(b.Of, s);
                    (!b.qb || b.Sf) && ic(s, b.pc)
                }
        ...
        function Gc(m, f) {
            var e = this, r, J, x, j, y = [], w, A, S, H, P, E, I, h, v, p;
            l.call(e, -G, G + 1, {});
            ...
            function C(a) {
                ...
                Q(m, a, 0);
                E = d;
                r = new bb.$Class(m, bb, b.Bb(m, "idle", dc), !u);
                r.H(0)
            }
            ...
            function W(b) {
                if (b == db && s == f) {
                    if (!h) {
                        var a = g;
                        if (D) if (D.mb == f) a = D.ye(); else D.ob();
                        U();
                        h = new Fc(m, f, a, r);
                        h.Nd(p)
                    }
            ...
            function F(a, d, k) {
                if (a == f) {
                    if (a != d) B[d] && B[d].Hd(); else !k && h && h.af();
                    p && p.$Enable();
                    var l = db = b.W();
                    e.Db(b.$CreateCallback(g, W, l))
                } else {
                    var j = c.min(f, a), i = c.max(f, a), o = c.min(i - j, j + q - i), m = G + n.$LazyLoading - 1;
                    (!P || o <= m) && e.Db()
                }
            }
                    ...
                    if (!S) {
                        ...
                        b.$Each(y, function (a) {
                            if (!b.$Attribute(a, "src")) {
                                ...
                                b.zb(a, a["display-origin"])
                            }
                        })
                    }
                    b.Yf(y, j, b.$CreateCallback(g, M, e, c))
                } else M(e, c)
            };
            e.gf = function () {
                if (q == 1) {
                    ...
                    var a = D.cg(q);
                    if (a) {
                        var h = db = b.W(), c = f + lb, d = B[t(c)];
                        return d.Db(b.$CreateCallback(g, T, c, d, a, h), x)
                    }
                } else Nb(lb)
            };
            e.Dc = function () {
            ...
            function Q(a, f, c, h) {
                ...
                b.$Each(i, function (a) {
                    ...
                    if (g == "caption") {
                        if (f) {
                            b.Ag(a, b.$AttributeEx(a, "to"));
                            b.tg(a, b.$AttributeEx(a, "bf"));
                            I && b.$AttributeEx(a, "3d") && b.sg(a, "preserve-3d")
                        }
                    } else if (!E && !c && !j) {
                        if (e == "A") {
        ...
        function Fc(z, g, p, q) {
            ...
            function w() {
                b.Bc(T);
                pc && m && o.Bd && b.$AppendChild(T, o.Bd);
                b.A(T, !m && o.Zb)
            }
            ...
            c.Fc = function () {
                ...
                if (!A && !Z && !r && s == g) {
                    ...
                    if (b != e) if (b == f) k = e; else if (b == j) k = f; else if (!b) k = j; else k = c.Vd();
                    a.j(p, g, b, n, j, f, e);
                    var l = u && (!H || M);
                    if (b == e) (f != e && !(H & 12) || l) && o.gf(); else (l || b != f) && c.Cd(k, x)
                }
            };
            c.af = function () {
                f == e && f == c.Z() && c.H(j)
            ...
            c.Ld = function (a) {
                p && b.Ab(Y, a && p.Vc.$Outside ? "" : "hidden")
            };
            c.Pc = function (c, b) {
                if (m && b >= h) {
                    m = k;
        ...
        function nc(c, b) {
            var a = x > 0 ? x : S, d = yb * b * (a & 1), e = zb * b * (a >> 1 & 1);
            Hb(c, d, e)
        }
        ...
        function Tb(a) {
            !b.Kb(b.$EvtSrc(a), "nodrag") && b.$CancelEvent(a)
        }
        ...
        function mc(c, j) {
            ...
            if ((!l || l === v) && !V && (!j || c.touches.length == 1)) {
                xb = b.Kb(e, "nodrag") || !mb || !Ec();
                var n = b.Kb(e, f, m.Ec);
                if (n) Xb = b.$Attribute(n, m.Ec);
                if (j) {
                    var p = c.touches[0];
                    Jb = p.clientX;
                    Kb = p.clientY
        ...
        function Qb(g) {
            if (A) {
                ...
                } else ib(); else a = b.Od(g);
                if (a) {
                    var e = a.x - Jb, f = a.y - Kb;
                    if (x || c.abs(e) > 1.5 || c.abs(f) > 1.5) {
                        if (c.floor(F) != F) x = x || S & V;
                        if ((e || f) && !x) {
                            if (V == 3) if (c.abs(f) > c.abs(e)) x = 2; else x = 1; else x = V;
                        ...
                        if (P - sb < -1.5) tb = 0; else if (P - sb > 1.5) tb = -1;
                        sb = P;
                        P = n;
                        W = F - P / i / Xb;
                        if (!(C & 1)) {
                            var l = 0, j = [-F + O, 0, F - q + U - O];
        ...
        function vc(c) {
            var a = b.$EvtSrc(c), d = b.Kb(a, "1", Fb);
            if (v === d) if (R) {
                b.$StopEvent(c);
                while (a && v !== a) {
        ...
        function Mc(d) {
            if (d != s) {
                var b = nb.Z(), a = Cb(d), e = c.round(t(a));
                if (b - a < .5) a = b;
                B[s];
                s = e;
                Ib = B[s];
        ...
        function Ab(l, g, m, o) {
            if (!A && (M || !(H & 12)) || n.$NaviQuitDrag) {
                ...
                var a = e;
                if (!(C & 1)) {
                    if (o) a = t(a); else if (C & 2 && (a < 0 && c.abs(b - E) < .0001 || a > q - U && c.abs(b - I) < .0001)) a = a < 0 ? I : E;
                    a = Cb(a);
                    if (I - a < .5) a = I;
                    if (a - E < .5) a = E
                }
        ...
        a.Sd = function (a) {
            a = t(a);
            if (C & 1) {
                var d = cb / gb, b = t(nb.Z()), e = t(a - b + d), f = t(c.abs(a - b));
                if (e >= G) {
        ...
        a.Wb = function (x, l) {
            ...
            b.$Each(m, function (a, d) {
                ...
                if (c == "loading") X = a; else {
                    ...
                    if (a.tagName != "STYLE" && a.tagName != "SCRIPT") ac[c || d] = new wc(a, c == "slides", b.bg(["slides", "thumbnavigator"])[c])
                }
            });
            X = X || b.$CreateDiv(h);
            rb = b.$CssWidth(y);
            ...
            if (q) {
                ...
                Sb.Ed && b.$Css(y, Sb.Ed, ([g, "pan-y", "pan-x", "none"])[mb] || "");
                if (ec) D = new Gb(Lb, N, L, kb, ub, Hb);
                for (var i = 0; i < fb.length; i++) {
                    var s = fb[i], w = new Gc(s, i);
                    B.push(w)
                }
                b.X(X);
                nb = new Ic;
