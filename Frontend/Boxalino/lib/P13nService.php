...
interface P13nServiceIf {
  ...
  /**
   * @param \com\boxalino\p13n\api\thrift\ChoiceRequestBundle $bundle
   * @return \com\boxalino\p13n\api\thrift\ChoiceResponseBundle
   * @throws \com\boxalino\p13n\api\thrift\P13nServiceException
   */
  public function chooseAll(\com\boxalino\p13n\api\thrift\ChoiceRequestBundle $bundle);
  /**
   * <dl>
...
class P13nServiceClient implements \com\boxalino\p13n\api\thrift\P13nServiceIf {
  ...
  public function chooseAll(\com\boxalino\p13n\api\thrift\ChoiceRequestBundle $bundle)
  {
    ...
    return $this->recv_chooseAll();
  }

  public function send_chooseAll(\com\boxalino\p13n\api\thrift\ChoiceRequestBundle $bundle)
  {
    $args = new \com\boxalino\p13n\api\thrift\P13nService_chooseAll_args();
    $args->bundle = $bundle;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'chooseAll', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('chooseAll', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_chooseAll()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\com\boxalino\p13n\api\thrift\P13nService_chooseAll_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \com\boxalino\p13n\api\thrift\P13nService_chooseAll_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("chooseAll failed: unknown result");
  }
...
class P13nService_chooseAll_args {
  static $_TSPEC;

  /**
   * @var \com\boxalino\p13n\api\thrift\ChoiceRequestBundle
   */
  public $bundle = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        -1 => array(
          'var' => 'bundle',
          'type' => TType::STRUCT,
          'class' => '\com\boxalino\p13n\api\thrift\ChoiceRequestBundle',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'P13nService_chooseAll_args';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case -1:
          if ($ftype == TType::STRUCT) {
            $this->bundle = new \com\boxalino\p13n\api\thrift\ChoiceRequestBundle();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('P13nService_chooseAll_args');
    if ($this->bundle !== null) {
...
class P13nService_chooseAll_result {
  static $_TSPEC;

  /**
   * @var \com\boxalino\p13n\api\thrift\ChoiceResponseBundle
   */
  public $success = null;
  /**
   * @var \com\boxalino\p13n\api\thrift\P13nServiceException
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\com\boxalino\p13n\api\thrift\ChoiceResponseBundle',
          ),
        1 => array(
          'var' => 'p13nServiceException',
          'type' => TType::STRUCT,
  ...
  public function getName() {
    return 'P13nService_chooseAll_result';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \com\boxalino\p13n\api\thrift\ChoiceResponseBundle();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('P13nService_chooseAll_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
